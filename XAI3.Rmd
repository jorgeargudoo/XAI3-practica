...
plot_bedrooms <- autoplot(pdp_bedrooms) + ggtitle("Bedrooms")

pdp_bathrooms <- partial(rf_house, pred.var = "bathrooms", grid.resolution = 20)
plot_bathrooms <- autoplot(pdp_bathrooms) + ggtitle("Bathrooms")

pdp_sqft <- partial(rf_house, pred.var = "sqft_living", grid.resolution = 20)
plot_sqft <- autoplot(pdp_sqft) + ggtitle("Sqft Living")

pdp_floors <- partial(rf_house, pred.var = "floors", grid.resolution = 20)
plot_floors <- autoplot(pdp_floors) + ggtitle("Floors")
